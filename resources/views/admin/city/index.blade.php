                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <!-- Delete Button -->
                                                <form action="{{ route('city.destroy', ['city' => $city]) }}" method="post" style="margin-right: 10px;">
                                                    @csrf
                                                    @method('delete')
                                                ...
                                                <!-- Update Button -->
                                                <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#editCityModal-{{ $city->id }}">Update</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
